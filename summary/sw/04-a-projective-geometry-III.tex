...
\textit{Der Abstand der Ebene zum Zentrum entspricht $\pm d$, abhängig davon ob die ebene oberhalb (positive Achse -> -d) oder unterhalb (negative Achse -> +d) befindet.}

\includegraphics[scale=0.5]{distance_matrix} \\
